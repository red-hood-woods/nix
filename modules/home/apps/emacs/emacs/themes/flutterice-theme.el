;;; flutterice-theme.el --- Theme using Template SCSS variables -*- lexical-binding: t -*-
...
(deftheme flutterice "Theme using Template variables with quality of life improvements.")

;; Define all the color variables (replaced by template processor)
(let* ((bg "#1e1010")
      (err "#ffb4ab")
      (err-container "#93000a")
      (on-background "#f8dcdb")
      (on-err "#690005")
      (on-err-container "#ffdad6")
      (on-primary "#51145a")
      (on-primary-container "#ffd6fd")
      (on-secondary "#49204e")
      (on-secondary-container "#ffd6fd")
      (on-surface "#f8dcdb")
      (on-surface-variant "#e6bdbc")
      (on-tertiary "#561d20")
      (on-tertiary-container "#ffdad9")
      (outline-color "#ad8887")
      (outline-variant "#5d3f3f")
      (primary "#f8adfb")
      (primary-container "#6b2d72")
      (secondary "#ecb5ec")
      (secondary-container "#623766")
      (shadow "#000000")
      (surface "#1e1010")
      (surface-container "#2b1c1b")
      (surface-container-high "#362626")
      (surface-container-highest "#423030")
      (surface-container-low "#271818")
      (surface-container-lowest "#180b0b")
      (surface-variant "#5d3f3f")
      (tertiary "#ffb3b2")
      (tertiary-container "#733335")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#ffb3b2")
      (on-success "#561d20")
      (success-container "#733335")
      (on-success-container "#ffdad9")
      ;; Map fixed colors to regular colors
      (primary-fixed "#f8adfb")
      (primary-fixed-dim "#6b2d72")
      (secondary-fixed "#ecb5ec")
      (secondary-fixed-dim "#623766")
      (tertiary-fixed "#ffb3b2")
      (tertiary-fixed-dim "#733335")
      (on-primary-fixed "#51145a")
      (on-primary-fixed-variant "#ffd6fd")
      (on-secondary-fixed "#49204e")
      (on-secondary-fixed-variant "#ffd6fd")
      (on-tertiary-fixed "#561d20")
      (on-tertiary-fixed-variant "#ffdad9")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#f8dcdb")
      (inverse-primary "#f8adfb")
      (inverse-surface "#1e1010")
